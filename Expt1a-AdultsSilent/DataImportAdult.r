...
data_import <- function(path_name,type = "AdSil"){ 
...
adult.sac = sac.process("./",Pop = c("AdSil"))
...
if (file.exists("AdultWriteNames.txt") == TRUE){
	names = read.delim("AdultWriteNames.txt")
...
BarPlotGaze(adult.ref.t.s, "DwellTime","DwellTime")
BarPlotGaze(adult.ref.t.s, "FixCount","DwellTime")
BarPlotGaze(adult.ref.t.s, "PropDwell","DwellTime")
BarPlotGaze(adult.ref.t.s, "PropFix","DwellTime")