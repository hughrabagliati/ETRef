...
**Methods**   
*Participants*   
40 3- to 5-year-old children from the Edinburgh area (X female, Mean Age (in months) = , SD = ). We did not record detailed demographic information, but we estimate that most children were White, from middle-class families. Children were tested in the Developmental Lab at the University of Edinburgh as well as in local pre-schools [ALEX PLEASE AMEND .
...
Pictures were again arranged in a T shape, but had larger dimensions than in Experiment 2 [SIZE AND WIDTH]. **DISCUSS PICTURE SIZES ETC**
...
For the eye movement analyses, we defined ROIs [SIZE!] around the border of each picture, and analyzed eye movements that landed directly within the ROIs. Our first analyses aimed to replicate the finding that children are more likely to monitor for ambiguity before producing an informative description of the Target picture, again using a mixed effects model of the form Proportion of Saccades ~ Scene Type + (1|Subject). Then, we anlyzed whether children were more likely to have engaged in comprehension monitoring before producing an informative description of the Foil picture. To do this, we analyzed whether participants were more likey to provide informative descriptions of the foil picture if they had spent more time fixating it in the 1500ms before they were told to name it, and whether this effect depended on the scene type (ambiguous/unambiguous). To do this, we used a logistic regression of the form Foil Label ~ Fixation time to foil * Scene Type + (1|Subject).
